...
TEST(DeflateTests, DeflateDecompressFile) {
    std::vector<uint8_t> decompressed_data = System::IO::Compression::DeflateStream::Decompress(System::IO::File::ReadAllBytes("compressedwithbom.deflate"));
...
TEST(DeflateTests, DeflateDecompressFile2) {
    std::vector<uint8_t> decompressed_data = System::IO::Compression::DeflateStream::Decompress(System::IO::File::ReadAllBytes("nobommatchmatch.deflate"));
    std::string decompressed_string(decompressed_data.begin(), decompressed_data.end());
...
TEST(DeflateTests, DeflateCompressDecompressRoundtrip) {
    ...
    std::vector<uint8_t> compressed_data = System::IO::Compression::DeflateStream::Compress(original_data, System::IO::Compression::DeflateStream::CompressionLevel::Level1);
    std::vector<uint8_t> decompressed_data = System::IO::Compression::DeflateStream::Decompress(compressed_data);
